...
import { useCreateCashboxMutation } from '../redux/api';
...
const CreateCashbox: React.FC = () => {
  ...
  return (
    <>
      <GoBackForm> Create cashbox </GoBackForm>
      <ContentWrapper>
